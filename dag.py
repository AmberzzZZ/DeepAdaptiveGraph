...
if __name__ == '__main__':
    ...
    affine_gcn = GCN_global(in_dim=256, out_dim=256, out_features=9, num_nodes=24)
    affine_gcn.summary()


    inpt = Input((24, 256))   # (b,N,D)
    adj = Input((24, 24))   # (b,N,N)
    delta = Input((24, 24*2))       # (b,N,N*2)

    y = affine_gcn([inpt, adj, delta])
    print(y)
